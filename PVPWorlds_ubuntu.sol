...
contract PVPWorlds is ERC721A("PVPWorlds", "PVP"), Ownable, ERC721ABurnable {
    using Strings for uint256;
    ...
    uint256 public publicmintActiveTime = 0; //still not finalized
    ...
    uint256 public presaleActiveTime = 0; //still not finalized
